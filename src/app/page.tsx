    ...
    return(
        <main className="w-screen max-w-full scroll-smooth">
            ...
            <i className="fa fa-linkedin hover:text-cyan-500"></i>
                ...
                <li className="hover:text-cyan-500 pt-3"><Link href={"#services"}>Services</Link></li>
                <li className="hover:text-cyan-500 pt-3"><Link href={"#about"}>About</Link></li>
                <li className="hover:text-cyan-500 pt-3"><Link href={"#contact"}>Contact</Link></li>
                </ul>   
                </section>
